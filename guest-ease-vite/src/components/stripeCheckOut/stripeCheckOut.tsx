...
//   amount: number;
//   // onSuccess?: () => void;
//   onSuccess?: (paymentIntent: PaymentIntent) => void; // <- change here
// }) => {
...
//         // }
//         if (onSuccess) onSuccess(result.paymentIntent); // <-- pass paymentIntent here
//       }
//     } catch (err) {
...
// }: {
//   amount: number;
//   onSuccess?: (paymentIntent: PaymentIntent) => void; // <- must accept PaymentIntent
// }) => (
//   <Elements stripe={stripePromise}>
//     <CheckoutForm amount={amount} onSuccess={onSuccess} />
//   </Elements>
