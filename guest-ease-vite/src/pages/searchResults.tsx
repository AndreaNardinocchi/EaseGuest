...
//                     image={(() => {
//                       try {
//                         // If images is a string, parse it; if array, use directly
//                         const imagesArray =
//                           typeof room.images === "string"
//                             ? JSON.parse(room.images)
//                             : room.images;
...
// // ---------- Normalizers (no JSON.parse needed now) ----------
// const normalizeImages = (val: any): string[] => (Array.isArray(val) ? val : []);
...
//         const result = await searchAvailableRooms(checkIn, checkOut);
//         console.log("Raw RPC result:", result.rooms);

//         if (result.success) {
//           const parsed = result.rooms.map((room: Room) => ({
//             ...room,
...
//               console.log(`Room "${room.name}" image used:`, firstImage);
...
//                       >
//                         {room.description ||
//                           "A comfortable room for your stay."}
//                       </Typography>
